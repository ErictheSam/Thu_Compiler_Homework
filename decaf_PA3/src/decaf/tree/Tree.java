...
public abstract class Tree {
    ...
    public static final int GUARDSTMT = SCOPY + 1;
    public static final int SUBSTMT = GUARDSTMT + 1;
    public static final int VARVALUE = SUBSTMT + 1;
    public static final int TIMEARRAYCONST = VARVALUE + 1;
    public static final int DEFAULT = TIMEARRAYCONST + 1;
    public static final int FOREACHLOOP = DEFAULT + 1;
    ...
    public static class GuardStmt extends Tree {
    	...
    	public List<SubStmt> works;//一群woerk
    ...
    public static class VarDef extends Tree {
    	...
    	public String name;
    	public TypeLiteral type;//literal中间设定type
    ...
    public abstract static class LValue extends Expr {
    	...
    	public enum Kind {
    		LOCAL_VAR, PARAM_VAR, MEMBER_VAR, ARRAY_ELEMENT, VAR_IDENT
    	}
    	public Kind lvKind;
    	public String name;
    	public Variable symbol;
    ...
    public static class VarValue extends LValue {

    	public VarValue(String name, Location loc) {
    		super(VARVALUE, loc);
    		this.name = name;	
    	}
    	
    	public void accept(Visitor v) {
    		v.visitVarValue(this);
    	}
    ...
    public static abstract class TypeLiteral extends Tree {//中间有type
  ...
  public static class Scopy extends Expr {
    	...
    	public Scopy(LValue lvalue, Expr expr, Location loc, Location lloc, Location rloc) {
    		super(SCOPY, loc);
    		this.lvalue = lvalue;
    		this.expr = expr;
    		this.lloc = lloc;
    ...
    public static class DefaultConst extends Expr {//这个东西
    	public Expr array;
    	public Expr rank;
    	public Expr rexpr;
   ...
   public static class ForeachLoop extends Tree {
    	...
    	public VarDef var;
    	public VarValue unkvar;
    	public Expr rexpr;
    	public Expr condexpr;
    	public Block ownBlock;
    	
    	public ForeachLoop(VarDef var, VarValue unkvar, Expr rexpr, Expr condexpr, Block loopbody ,Location loc) {//var可以是class类的
    		super(FOREACHLOOP,loc);
    		this.var = var;
    		this.unkvar = unkvar;
    		this.rexpr = rexpr;
    		this.condexpr = condexpr;
    		this.ownBlock = loopbody;//变成新的block
    	}
    ...
    public static abstract class Visitor {
        ...
        public void visitDefaultConst(DefaultConst that) {
        	visitTree(that);
        }
        
        public void visitTimeArrayConst(TimeArrayConst that) {
        	visitTree(that);
        }
        
        public void visitVarValue(VarValue that) {
        	visitTree(that);
        }
        
        public void visitSubStmt(SubStmt that) {
            visitTree(that);
        }
